	...
	class Exhibitors
	{
		...
		public function createPostType()
		{
			if ( !post_type_exists( self::POST_TYPE ) )
			{
				...
				(
					...
					'add_new'				=> __( 'Add New Exhibitor' ),
					'add_new_item'			=> __( 'Add New Exhibitor' ),
					'edit'					=> __( 'Edit Exhibitor' ),
					'edit_item'				=> __( 'Edit Exhibitor' ),
					'new_item'				=> __( 'Add New Exhibitor' ),
		...
		public function loadAdminResources()
		{
			...
			if ($typenow==self::POST_TYPE) {
				...
				wp_enqueue_style(
						'exhibitors',
						get_template_directory_uri() . '/lib/cpt/exhibitors/css/exhibitors.css',
						false,
						false,
						'screen');
			}
		...
		{
			//add a custom image size for exhibitor images
			add_image_size( 'exhibitor', 400, 130, true );
		}
